...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for entry in symbol_quantity_list:
        ...
        if symbol in periodic_table_dict:
            ...
            print(f"Element with symbol '{symbol}' not found in the periodic table.")
...
def main():
    ...
    symbol_quantity_list = parse_formula(chemical_formula, periodic_table)  # Pass the periodic_table as an argument

    molar_mass = compute_molar_mass(symbol_quantity_list, periodic_table)

    moles = sample_mass / molar_mass

    print(f"Molar mass of the molecule: {molar_mass} g/mol")
    print(f"Number of moles in the sample: {moles} moles")
